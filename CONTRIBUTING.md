...
Before asking a question, please search for existing [Issues](https://gitea.barcelli.net/kikobar/staffany/issues) that might help you. In case you found a suitable issue but still need clarification, you can write your question in this issue.

If you still need to ask a question we recommend:

* Open and [Issue](https://gitea.barcelli.net/kikobar/staffany/issues/new).
...
* Open an [Issue](https://gitea.barcelli.net/kikobar/staffany/issues/new).
...
* Search and read carefully for existing discussions about similar suggestions in the [Issues](https://gitea.barcelli.net/kikobar/staffany/issues). You may consider adding your comments or suggestion to an existing issue.
